...
def test_route_word_single_success_case_one(client: FlaskClient):
    resp = client.post(
...
def test_route_word_single_success_case_two(client: FlaskClient):
    resp = client.post(
        base_url.format("/translate/word"),
...
def test_route_word_single_success_case_three(client: FlaskClient):
    resp = client.post(
        base_url.format("/translate/word"),
...
def test_route_word_single_failure_case_one(client: FlaskClient):
    resp = client.post(
        base_url.format("/translate/word"),
...
def test_route_word_single_failure_case_two(client: FlaskClient):
    resp = client.post(
        base_url.format("/translate/word"),
...
def test_route_word_single_failure_case_three(client: FlaskClient):
    resp = client.post(
        base_url.format("/translate/word"),
...
def test_route_word_single_failure_case_four(client: FlaskClient):
    resp = client.post(
        base_url.format("/translate/word"),
