...
def test_controller_word_single_success_case_one(controller_word: ControllerWord):
    resp = run(
...
def test_controller_word_single_success_case_two(controller_word: ControllerWord):
    resp = run(
...
def test_controller_word_single_success_case_three(controller_word: ControllerWord):
    resp = run(
...
def test_controller_word_single_failure_case_one(controller_word: ControllerWord):
    resp = run(
...
def test_controller_word_single_failure_case_two(controller_word: ControllerWord):
    resp = run(
...
def test_controller_word_single_failure_case_three(controller_word: ControllerWord):
    resp = run(
...
def test_controller_word_single_failure_case_four(controller_word: ControllerWord):
    resp = run(
...
def test_controller_word_single_failure_case_five(controller_word: ControllerWord):
    resp = run(
